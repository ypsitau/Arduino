...
void setup()
{
	...
	serial.Printf("%%8u 1234      '%8u'\n", 1234);
	serial.Printf("%%8u -1234     '%8u'\n", -1234);
	serial.Printf("%%-8u 1234     '%-8u'\n", 1234);
	serial.Printf("%%-8u -1234    '%-8u'\n", -1234);
	serial.Printf("%%08u 1234      '%08u'\n", 1234);
	serial.Printf("%%08u -1234     '%08u'\n", -1234);
	serial.Printf("%%-08u 1234     '%-08u'\n", 1234);
	serial.Printf("%%-08u -1234    '%-08u'\n", -1234);
	// %b specifier
	...
	serial.Printf("%%18b 1234      '%18b'\n", 1234);
	serial.Printf("%%18b -1234     '%18b'\n", -1234);
	serial.Printf("%%-18b 1234     '%-18b'\n", 1234);
	serial.Printf("%%-18b -1234    '%-18b'\n", -1234);
	serial.Printf("%%018b 1234      '%018b'\n", 1234);
	serial.Printf("%%018b -1234     '%018b'\n", -1234);
	serial.Printf("%%-018b 1234     '%-018b'\n", 1234);
	serial.Printf("%%-018b -1234    '%-018b'\n", -1234);
	// %o specifier
